...
public class JapaneseDateTypeHandler extends BaseTypeHandler<JapaneseDate> {
    ...
    @Override
    public void setNonNullParameter(PreparedStatement ps, int i, JapaneseDate parameter,
    ...
    @Override
    public JapaneseDate getNullableResult(CallableStatement cs, int columnIndex)
            throws SQLException {
