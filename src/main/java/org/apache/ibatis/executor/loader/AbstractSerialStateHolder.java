...
public abstract class AbstractSerialStateHolder implements Externalizable {
    ...
    private static final ThreadLocal<ObjectOutputStream> stream =
    ...
    public AbstractSerialStateHolder(final Object userBean,
            ...
            final ObjectFactory objectFactory, List<Class<?>> constructorArgTypes,
    ...
    protected final Object readResolve() throws ObjectStreamException {
        ...
        try {
            final ObjectInputStream in =
                    new ObjectInputStream(new ByteArrayInputStream(this.userBeanBytes));
            ...
            throw (ObjectStreamException) new InvalidClassException(ex.getLocalizedMessage())
                    .initCause(ex);
        }
        ...
        return this.createDeserializationProxy(userBean, arrayProps, objectFactory, arrayTypes,
                arrayValues);
    }
