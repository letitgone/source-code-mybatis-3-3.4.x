...
public class ResultSetWrapper {
    ...
    private final Map<String, List<String>> mappedColumnNamesMap =
            new HashMap<String, List<String>>();
    private final Map<String, List<String>> unMappedColumnNamesMap =
            new HashMap<String, List<String>>();
    ...
    public List<String> getMappedColumnNames(ResultMap resultMap, String columnPrefix)
        ...
        List<String> mappedColumnNames =
                mappedColumnNamesMap.get(getMapKey(resultMap, columnPrefix));
