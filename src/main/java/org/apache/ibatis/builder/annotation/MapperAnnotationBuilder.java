...
public class MapperAnnotationBuilder {
        ...
        if (!configuration.isResourceLoaded("namespace:" + type.getName())) {
            ...
            if (inputStream != null) {
                XMLMapperBuilder xmlParser =
                        new XMLMapperBuilder(inputStream, assistant.getConfiguration(), xmlResource,
    ...
    private Discriminator applyDiscriminator(String resultMapId, Class<?> resultType,
        ...
        if (discriminator != null) {
            ...
            @SuppressWarnings("unchecked") Class<? extends TypeHandler<?>> typeHandler =
    ...
    void parseStatement(Method method) {
        ...
        if (sqlSource != null) {
            ...
            assistant
                    .addMappedStatement(mappedStatementId, sqlSource, statementType, sqlCommandType,
                            fetchSize, timeout,
                            // ParameterMapID
                            null, parameterTypeClass, resultMapId, getReturnType(method),
            ...
            if (Collection.class.isAssignableFrom(rawType) || Cursor.class
                ...
                if (actualTypeArguments != null && actualTypeArguments.length == 1) {
                    ...
                    if (returnTypeParameter instanceof Class<?>) {
                        ...
                        returnType =
                                (Class<?>) ((ParameterizedType) returnTypeParameter).getRawType();
    ...
    private SqlSource getSqlSourceFromAnnotations(Method method, Class<?> parameterType,
        ...
        try {
            ...
            Class<? extends Annotation> sqlProviderAnnotationType =
                    getSqlProviderAnnotationType(method);
    ...
    private void applyResults(Result[] results, Class<?> resultType,
        ...
        for (Result result : results) {
            ...
            @SuppressWarnings("unchecked") Class<? extends TypeHandler<?>> typeHandler =
                    (Class<? extends TypeHandler<?>>) ((result.typeHandler()
                            == UnknownTypeHandler.class) ? null : result.typeHandler());
            ResultMapping resultMapping = assistant
                    .buildResultMapping(resultType, nullOrEmpty(result.property()),
                            nullOrEmpty(result.column()),
                            result.javaType() == void.class ? null : result.javaType(),
                            result.jdbcType() == JdbcType.UNDEFINED ? null : result.jdbcType(),
                            hasNestedSelect(result) ? nestedSelectId(result) : null, null, null,
                            null, typeHandler, flags, null, null, isLazy(result));
            ...
            @SuppressWarnings("unchecked") Class<? extends TypeHandler<?>> typeHandler =
                    (Class<? extends TypeHandler<?>>) (
                            arg.typeHandler() == UnknownTypeHandler.class ?
                                    ...
                                    arg.typeHandler());
            ResultMapping resultMapping = assistant
                    .buildResultMapping(resultType, nullOrEmpty(arg.name()),
    ...
    private KeyGenerator handleSelectKeyAnnotation(SelectKey selectKeyAnnotation,
        ...
        assistant.addMappedStatement(id, sqlSource, statementType, sqlCommandType, fetchSize,
                timeout, parameterMap, parameterTypeClass, resultMap, resultTypeClass,
                resultSetTypeEnum, flushCache, useCache, false, keyGenerator, keyProperty,
