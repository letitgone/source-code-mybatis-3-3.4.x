...
public class MapperBuilderAssistant extends BaseBuilder {
    ...
    public void setCurrentNamespace(String currentNamespace) {
        ...
        if (this.currentNamespace != null && !this.currentNamespace.equals(currentNamespace)) {
            throw new BuilderException(
                    "Wrong namespace. Expected '" + this.currentNamespace + "' but found '"
                            + currentNamespace + "'.");
        }
    ...
    public Cache useNewCache(Class<? extends Cache> typeClass, Class<? extends Cache> evictionClass,
            Long flushInterval, Integer size, boolean readWrite, boolean blocking,
            Properties props) {
    ...
    public ParameterMapping buildParameterMapping(Class<?> parameterType, String property,
        ...
        Class<?> javaTypeClass =
                resolveParameterJavaType(parameterType, property, javaType, jdbcType);
        TypeHandler<?> typeHandlerInstance = resolveTypeHandler(javaTypeClass, typeHandler);

        return new ParameterMapping.Builder(configuration, property, javaTypeClass)
                .jdbcType(jdbcType).resultMapId(resultMap).mode(parameterMode)
                .numericScale(numericScale).typeHandler(typeHandlerInstance).build();
    }
    ...
    public Discriminator buildDiscriminator(Class<?> resultType, String column, Class<?> javaType,
        ...
        ResultMapping resultMapping =
                buildResultMapping(resultType, null, column, javaType, jdbcType, null, null, null,
    ...
    private ParameterMap getStatementParameterMap(String parameterMapName,
        ...
        if (parameterMapName != null) {
            ...
            parameterMap = new ParameterMap.Builder(configuration, statementId + "-Inline",
        ...
        if (columnName != null && (columnName.indexOf('=') > -1 || columnName.indexOf(',') > -1)) {
            ...
            while (parser.hasMoreTokens()) {
                ...
                ResultMapping complexResultMapping =
                        new ResultMapping.Builder(configuration, property, column,
    ...
    public MappedStatement addMappedStatement(String id, SqlSource sqlSource,
        ...
        return addMappedStatement(id, sqlSource, statementType, sqlCommandType, fetchSize, timeout,
                parameterMap, parameterType, resultMap, resultType, resultSetType, flushCache,
