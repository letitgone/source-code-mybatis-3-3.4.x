...
public class XMLConfigBuilder extends BaseBuilder {
    ...
    private void loadCustomVfs(Properties props) throws ClassNotFoundException {
        ...
        if (value != null) {
            ...
            for (String clazz : clazzes) {
                if (!clazz.isEmpty()) {
                    @SuppressWarnings("unchecked") Class<? extends VFS> vfsImpl =
                            (Class<? extends VFS>) Resources.classForName(clazz);
    ...
    private void settingsElement(Properties props) throws Exception {
        ...
        @SuppressWarnings("unchecked") Class<? extends TypeHandler> typeHandler =
                (Class<? extends TypeHandler>) resolveClass(
        ...
        @SuppressWarnings("unchecked") Class<? extends Log> logImpl =
            ...
            for (XNode child : context.getChildren()) {
                ...
                if (isSpecifiedEnvironment(id)) {
                    ...
                    Environment.Builder environmentBuilder =
                            new Environment.Builder(id).transactionFactory(txFactory)
