...
public class DefaultResultSetHandlerTest {
    ...
    public void shouldRetainColumnNameCase() throws Exception {
        ...
        final DefaultResultSetHandler fastResultSetHandler =
                new DefaultResultSetHandler(executor, ms, parameterHandler, resultHandler, boundSql,
                        rowBounds);
    ...
    public void shouldThrowExceptionWithColumnName() throws Exception {
        ...
        final DefaultResultSetHandler defaultResultSetHandler =
                new DefaultResultSetHandler(null/*executor*/, ms, null/*parameterHandler*/,
        ...
        try {
            defaultResultSetHandler
                    .createParameterizedResultObject(rsw, null/*resultType*/, constructorMappings,
    ...
    MappedStatement getMappedStatement() {
        ...
        return new MappedStatement.Builder(config, "testSelect",
