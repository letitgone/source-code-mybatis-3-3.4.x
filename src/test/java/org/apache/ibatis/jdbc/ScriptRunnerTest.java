...
public class ScriptRunnerTest extends BaseDataTest {
    ...
    public void shouldRunScriptsUsingProperties() throws Exception {
        ...
        DataSource dataSource =
                new UnpooledDataSource(props.getProperty("driver"), props.getProperty("url"),
    ...
    public void testLogging() throws Exception {
        ...
        assertEquals(
                "select userid from account where userid = 'j2ee'" + LINE_SEPARATOR + LINE_SEPARATOR
    ...
    public void testLoggingFullScipt() throws Exception {
        ...
        assertEquals("select userid from account where userid = 'j2ee';" + LINE_SEPARATOR
                        + LINE_SEPARATOR + "USERID\t" + LINE_SEPARATOR + "j2ee\t" + LINE_SEPARATOR,
                sw.toString());
    }
    ...
    public void shouldAcceptDelimiterVariations() throws Exception {
        ...
        verify(stmt, Mockito.times(1)).execute(
                eq("line 1;" + LINE_SEPARATOR + "line 2;" + LINE_SEPARATOR + LINE_SEPARATOR));
