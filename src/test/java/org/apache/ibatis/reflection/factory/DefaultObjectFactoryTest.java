...
public class DefaultObjectFactoryTest {
    ...
    public void createClass() throws Exception {
        ...
        TestClass testClass = defaultObjectFactory
                .create(TestClass.class, Arrays.<Class<?>>asList(String.class, Integer.class),
    ...
    public void createClassThrowsProperErrorMsg() {
        ...
        try {
            defaultObjectFactory
                    .create(TestClass.class, Collections.<Class<?>>singletonList(String.class),
            ...
            Assert.assertTrue("Should not have trailing commas in types list",
                    e.getMessage().contains("(String)"));
            Assert.assertTrue("Should not have trailing commas in values list",
                    e.getMessage().contains("(foo)"));
        }
    }
