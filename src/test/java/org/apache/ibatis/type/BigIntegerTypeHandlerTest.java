...
public class BigIntegerTypeHandlerTest extends BaseTypeHandlerTest {
    ...
    public void shouldSetParameter() throws Exception {
        TYPE_HANDLER
                .setParameter(ps, 1, new BigInteger("707070656505050302797979792923232303"), null);
    ...
    public void shouldGetResultFromResultSetByName() throws Exception {
        ...
        assertEquals(new BigInteger("707070656505050302797979792923232303"),
