...
public class BlobInputStreamTypeHandlerTest extends BaseTypeHandlerTest {
    ...
    public static void setupSqlSessionFactory() throws Exception {
        ...
        BaseDataTest
                .runScript(dataSource, "org/apache/ibatis/type/BlobInputStreamTypeHandlerTest.sql");
    ...
    public void integrationTest() throws IOException {
        ...
        try {
            ...
            // select (Blob -> InputStream)
            {
                ...
                assertThat(new BufferedReader(new InputStreamReader(blobContent.getContent()))
                        .readLine()).isEqualTo("Hello");
            }
        } finally {
            session.close();
        }
