...
public class TypeHandlerRegistryTest {
    ...
    public void shouldRegisterAndRetrieveTypeHandler() {
        ...
        assertEquals(stringTypeHandler,
    ...
    public void shouldRegisterAndRetrieveComplexTypeHandler() {
        TypeHandler<List<URI>> fakeHandler = new TypeHandler<List<URI>>() {
            ...
            @Override
            public void setParameter(PreparedStatement ps, int i, List<URI> parameter,
    ...
    public void shouldBindHandlersToWrapersAndPrimitivesIndividually() {
        ...
        assertSame(IntegerTypeHandler.class,
                typeHandlerRegistry.getTypeHandler(int.class).getClass());
        ...
        assertSame(IntegerTypeHandler.class,
                typeHandlerRegistry.getTypeHandler(Integer.class).getClass());
        typeHandlerRegistry.register(Integer.class, IntegerTypeHandler.class);
    }
    ...
    public void shouldReturnHandlerForSuperclassIfRegistered() {
        ...
        assertEquals(DateTypeHandler.class,
                typeHandlerRegistry.getTypeHandler(MyDate.class).getClass());
    }
    ...
    public void shouldReturnHandlerForSuperSuperclassIfRegistered() {
        ...
        assertEquals(DateTypeHandler.class,
                typeHandlerRegistry.getTypeHandler(MyDate2.class).getClass());
    }
    ...
    enum ImplementingMultiInterfaceSomeEnum
            implements NoTypeHandlerInterface, ExtendingSomeInterface {
    }
    ...
    public static class SomeInterfaceTypeHandler<E extends Enum<E> & SomeInterface>
    ...
    public void demoTypeHandlerForSuperInterface() {
        ...
        assertNull("Registering interface works only for enums.",
                typeHandlerRegistry.getTypeHandler(SomeClass.class));
        ...
        assertSame(SomeInterfaceTypeHandler.class,
                typeHandlerRegistry.getTypeHandler(ImplementingMultiInterfaceSomeEnum.class)
                        .getClass());
    }
