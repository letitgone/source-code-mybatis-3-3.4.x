...
public class RefCursorTest {
    ...
    public static void setUp() throws Exception {
        ...
        String url = postgres.start(EmbeddedPostgres
                        .cachedRuntimeConfig(Paths.get(System.getProperty("java.io.tmpdir"), "pgembed")),
                "localhost", SocketUtil.findFreePort(), "refcursor", "postgres", "root",
    ...
    public void testRefCursor1() throws IOException {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            @SuppressWarnings("unchecked") List<Order> orders =
                    (List<Order>) parameter.get("order");
