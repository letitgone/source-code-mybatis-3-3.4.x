...
public class RawSqlSourceTest {
    ...
    public static void setUp() throws Exception {
        ...
        Reader reader = Resources.getResourceAsReader(
                "org/apache/ibatis/submitted/raw_sql_source/mybatis-config.xml");
        ...
        reader = Resources
                .getResourceAsReader("org/apache/ibatis/submitted/raw_sql_source/CreateDB.sql");
    ...
    private void test(String statement, Class<? extends SqlSource> sqlSource) {
        ...
        try {
            Assert.assertEquals(sqlSource,
                    sqlSession.getConfiguration().getMappedStatement(statement).getSqlSource()
                            .getClass());
