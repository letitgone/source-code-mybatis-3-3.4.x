    ...
    public static void setUp() throws Exception {
        ...
        try {
            ...
            Reader reader = Resources
                    .getResourceAsReader("org/apache/ibatis/submitted/dynsql2/CreateDB.sql");
            ...
            reader = Resources
                    .getResourceAsReader("org/apache/ibatis/submitted/dynsql2/MapperConfig.xml");
    ...
    public void testDynamicSelectWithTypeHandler() {
        ...
        try {
            ...
            List<Map<String, Object>> answer = sqlSession
                    .selectList("org.apache.ibatis.submitted.dynsql2.dynamicSelectWithTypeHandler",
                            parameter);
