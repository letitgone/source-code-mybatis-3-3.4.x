...
public class ColumnPrefixTest {
    ...
    public void setUp() throws Exception {
        ...
        try {
            ...
            Reader reader = Resources
                    .getResourceAsReader("org/apache/ibatis/submitted/column_prefix/CreateDB.sql");
    ...
    public void testComplexPerson() throws Exception {
        ...
        try {
            ...
            assertEquals("Has a big dog.",
                    ((AddressWithCaution) person1.getShippingAddress()).getCaution());
            ...
            assertEquals("No door bell.",
                    ((AddressWithCaution) person2.getBillingAddress()).getCaution());
    ...
    protected List<Pet> getPetAndRoom(SqlSession sqlSession) {
        List<Pet> pets = sqlSession
                .selectList("org.apache.ibatis.submitted.column_prefix.Mapper.selectPets");
        return pets;
    }

    protected List<Person> getPersons(SqlSession sqlSession) {
        List<Person> list = sqlSession
                .selectList("org.apache.ibatis.submitted.column_prefix.Mapper.selectPersons");
        return list;
    }
