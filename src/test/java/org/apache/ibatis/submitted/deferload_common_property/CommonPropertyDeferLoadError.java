...
public class CommonPropertyDeferLoadError {
    ...
    public static void initDatabase() throws Exception {
        ...
        try {
            ...
            conn = DriverManager
                    .getConnection("jdbc:hsqldb:mem:deferload_common_property", "sa", "");
            ...
            reader = Resources.getResourceAsReader(
                    "org/apache/ibatis/submitted/deferload_common_property/ibatisConfig.xml");
    ...
    public void testDeferLoadAfterResultHandler() {
        ...
        try {
            ...
            sqlSession
                    .select("org.apache.ibatis.submitted.deferload_common_property.ChildMapper.selectAll",
                            myResultHandler);
