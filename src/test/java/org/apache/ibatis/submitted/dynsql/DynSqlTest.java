...
public class DynSqlTest {
    ...
    public static void setUp() throws Exception {
        ...
        try {
            ...
            configReader.close();
            conn = sqlSessionFactory.getConfiguration().getEnvironment().getDataSource()
                    .getConnection();

            Reader scriptReader = Resources
                    .getResourceAsReader("org/apache/ibatis/submitted/dynsql/CreateDB.sql");
    ...
    public void testSelectSimple() {
        ...
        try {
            ...
            List<Map<String, Object>> answer = sqlSession
                    .selectList("org.apache.ibatis.submitted.dynsql.select_simple", parameter);
    ...
    public void testNumerics() {
        SqlSession sqlSession = sqlSessionFactory.openSession();
        try {
            List<NumericRow> answer =
                    sqlSession.selectList("org.apache.ibatis.submitted.dynsql.selectNumerics");
    ...
    public void testOgnlStaticMethodCall() {
        ...
        try {
            List<Map<String, Object>> answer = sqlSession
                    .selectList("org.apache.ibatis.submitted.dynsql.ognlStaticMethodCall",
                            "Rock 'n Roll");
            assertTrue(answer.size() == 1);
