...
public class AutomappingTest {
    ...
    public static void setUp() throws Exception {
        ...
        reader = Resources
                .getResourceAsReader("org/apache/ibatis/submitted/automapping/CreateDB.sql");
    ...
    public void shouldNotInheritAutoMappingInherited_InlineNestedResultMap() {
        ...
        try {
            ...
            Assert.assertNull("should not inherit auto-mapping",
                    user.getPets().get(0).getPetName());
