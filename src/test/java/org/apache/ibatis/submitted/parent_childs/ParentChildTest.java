...
public class ParentChildTest {
    ...
    public static void setUp() throws Exception {
        ...
        Reader reader = Resources.getResourceAsReader(
                "org/apache/ibatis/submitted/parent_childs/mybatis-config.xml");
        ...
        reader = Resources
                .getResourceAsReader("org/apache/ibatis/submitted/parent_childs/CreateDB.sql");
    ...
    public void shouldGetAUser() {
        ...
        try {
            ...
            Assert.assertEquals(0,
                    secondParent.getChilds().size()); // note an empty list is inyected
        } finally {
            sqlSession.close();
        }
    }
