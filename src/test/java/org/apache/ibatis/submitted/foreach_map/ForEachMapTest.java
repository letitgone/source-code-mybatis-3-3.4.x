...
public class ForEachMapTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        reader = Resources
                .getResourceAsReader("org/apache/ibatis/submitted/foreach_map/CreateDB.sql");
    ...
    public void shouldGetStringKeyStringValueEntries() {
        ...
        List<StringStringMapEntry> entries =
                sqlSession.selectList("sel_string_string", new MapParam());
