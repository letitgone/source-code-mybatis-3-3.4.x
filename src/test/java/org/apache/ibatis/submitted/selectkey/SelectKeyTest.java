...
public class SelectKeyTest {
    ...
    public void setUp() throws Exception {
        ...
        try {
            ...
            Reader reader = Resources
                    .getResourceAsReader("org/apache/ibatis/submitted/selectkey/CreateDB.sql");
            ...
            reader = Resources
                    .getResourceAsReader("org/apache/ibatis/submitted/selectkey/MapperConfig.xml");
    ...
    public void testSeleckKeyReturnsNoData() {
        ...
        try {
            ...
            parms.put("name", "Fred");
            int rows = sqlSession
                    .insert("org.apache.ibatis.submitted.selectkey.Table2.insertNoValuesInSelectKey",
                            parms);
            assertEquals(1, rows);
    ...
    public void testSeleckKeyReturnsTooManyData() {
        ...
        try {
            ...
            parms.put("name", "Fred");
            sqlSession
                    .insert("org.apache.ibatis.submitted.selectkey.Table2.insertTooManyValuesInSelectKey",
                            parms);
            sqlSession
                    .insert("org.apache.ibatis.submitted.selectkey.Table2.insertTooManyValuesInSelectKey",
                            parms);
    ...
    public void testSeleckKeyWithWrongKeyProperty() {
        ...
        try {
            Name name = new Name();
            name.setName("Kyoto");
            sqlSession.insert("org.apache.ibatis.submitted.selectkey.Table2.insertWrongKeyProperty",
                    name);
        } finally {
            sqlSession.close();
        }
