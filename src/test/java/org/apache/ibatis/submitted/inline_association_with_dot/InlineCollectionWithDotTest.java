...
public class InlineCollectionWithDotTest {
    ...
    public void openSession(String aConfig) throws Exception {
        ...
        final String resource =
                "org/apache/ibatis/submitted/inline_association_with_dot/ibatis-" + aConfig
                        + ".xml";
        ...
        try {
            ...
            throw new RuntimeException(
                    "Mapper configuration failed, expected this to work: " + anException
                            .getMessage(), anException);
        }
        ...
        Reader createScriptReader = Resources.getResourceAsReader(
