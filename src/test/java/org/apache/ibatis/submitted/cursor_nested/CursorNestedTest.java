...
public class CursorNestedTest {
    ...
    public static void setUp() throws Exception {
        ...
        Reader reader = Resources.getResourceAsReader(
                "org/apache/ibatis/submitted/cursor_nested/mybatis-config.xml");
        ...
        reader = Resources
                .getResourceAsReader("org/apache/ibatis/submitted/cursor_nested/CreateDB.sql");
    ...
    public void testCursorWithRowBound() {
        ...
        try {
            Cursor<User> usersCursor =
                    sqlSession.selectCursor("getAllUsers", null, new RowBounds(2, 1));
