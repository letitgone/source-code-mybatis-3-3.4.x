...
public class NestedForEachTest {
    ...
    public static void setUp() throws Exception {
        ...
        try {
            ...
            Reader reader = Resources
                    .getResourceAsReader("org/apache/ibatis/submitted/nested/CreateDB.sql");
            ...
            reader = Resources
                    .getResourceAsReader("org/apache/ibatis/submitted/nested/MapperConfig.xml");
    ...
    public void testSimpleSelect() {
        ...
        try {
            ...
            List<Map<String, Object>> answer = sqlSession
                    .selectList("org.apache.ibatis.submitted.nested.Mapper.simpleSelect",
                            parameter);
    ...
    public void testSimpleSelectWithPrimitives() {
        ...
        try {
            ...
            List<Map<String, Object>> answer = sqlSession.selectList(
                    "org.apache.ibatis.submitted.nested.Mapper.simpleSelectWithPrimitives",
                    parameter);
    ...
    public void testNestedSelect() {
        ...
        try {
            ...
            List<Map<String, Object>> answer = sqlSession
                    .selectList("org.apache.ibatis.submitted.nested.Mapper.nestedSelect",
                            parameter);
