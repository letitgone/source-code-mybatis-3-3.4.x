...
public class ReverseIncludeTest {
    ...
    private void testReverseIncludes(SqlSessionFactory sqlSessionFactory) throws Exception {
        ...
        try {
            ReverseIncludePersonMapper personMapper =
                    sqlSession.getMapper(ReverseIncludePersonMapper.class);
    ...
    private SqlSessionFactory getSqlSessionFactoryXmlConfig() throws Exception {
        Reader configReader = Resources.getResourceAsReader(
                "org/apache/ibatis/submitted/xml_external_ref/ReverseIncludeMapperConfig.xml");
