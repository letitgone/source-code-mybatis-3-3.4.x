...
public class UserTypeHandler extends BaseTypeHandler<User<String>> {
    ...
    @Override
    public void setNonNullParameter(PreparedStatement ps, int i, User<String> parameter,
    ...
    @Override
    public User<String> getNullableResult(CallableStatement cs, int columnIndex)
            throws SQLException {
        return new User<String>();
    }
