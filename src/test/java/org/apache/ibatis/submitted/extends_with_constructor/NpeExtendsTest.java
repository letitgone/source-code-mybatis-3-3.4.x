...
public class NpeExtendsTest {
    ...
    public static void initDatabase() throws Exception {
        ...
        try {
            ...
            conn = DriverManager
                    .getConnection("jdbc:hsqldb:mem:extends_with_constructor", "sa", "");
    ...
    private SqlSessionFactory getSqlSessionFactoryWithConstructor() {
        ...
        Environment environment =
                new Environment("extends_with_constructor", new JdbcTransactionFactory(),
    ...
    public void testSelectWithTeacher() {
        ...
        try {
            ...
            assertTrue(
                    testStudent.getConstructors().contains(StudentConstructor.Constructor.ID_NAME));
        } finally {
            sqlSession.close();
        }
    }
